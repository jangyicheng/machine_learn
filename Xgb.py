...
param_grid = {
    ...
    'scale_pos_weight': [5, 10, 15]  # 根据不平衡情况调整
}
...
bayes_params = {
    ...
    'max_depth': (max(4, grid_search.best_params_['max_depth'] - 2), grid_search.best_params_['max_depth'] + 2),
...
bayes_search = BayesSearchCV(
    estimator=XGBClassifier(random_state=42, use_label_encoder=False, eval_metric='f1'),
